...
it is not binding to the scenarios or framework (So it is not placed in alphaagent.core.utils)
"""

# TODO: merge the common utils in `alphaagent.core.utils` into this folder
