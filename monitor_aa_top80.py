...
def monitor_and_export():
    target_dir = Path("/home/tjxy/quantagent/AlphaAgent/backtest_v2_results_csi500_AA_top80")
    expected_process_pattern = "Alphaagent_csi500_AA_top80"
    ...
    while True:
        ...
        # We look for *daily_performance.csv in the target dir
        csv_file = None
...
def process_export(raw_csv_path):
    ...
    try:
        # Export logic from previous script
