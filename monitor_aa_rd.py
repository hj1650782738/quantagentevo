...
def monitor_and_export_rd():
    target_dir = Path("/home/tjxy/quantagent/AlphaAgent/backtest_v2_results_csi500_rd")
    expected_process_pattern = "Alphaagent_csi500_rd"
...
def process_export(raw_csv_path):
    ...
    try:
        ...
        output_csv_path = result_dir / "csi500_rd_cumulative_excess.csv"
